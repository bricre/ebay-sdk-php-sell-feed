...
class OrderTaskCollection extends AbstractModel
{
     ...
     * number of order tasks to return per page, from the result set. A result set is
     * the complete set of tasks returned by the method. Note: Though this parameter is
     ...
     * so the seller would have to make three separate getOrderTasks calls to view all
