...
Starting from version v1.3.1, this project will match according eBay API's versioning. Should you found a matching 
...
Client::configure(
    new \GuzzleHttp\Client([
        'base_uri' => 'https://api.ebay.com/sell/feed/v1/',
        'headers'=>[
